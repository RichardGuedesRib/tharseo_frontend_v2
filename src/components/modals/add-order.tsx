...
import { Bot, ChartArea, ChevronDown } from "lucide-react"
      ...
      <DrawerContent className="bg-bg-principal text-white">
        <div className="mx-auto w-full max-w-sm">
          <DrawerHeader>
            ...
            <DrawerDescription>Achou uma oportunidade de ouro? Abra uma ordem de compra ou venda.</DrawerDescription>
          </DrawerHeader>
